...
// Social icon config: label, url, icon, color - data source chung
export const SOCIAL_PLATFORMS = [
  ...
  },
  {
    ...
    color: "bg-gradient-to-br from-pink-500 to-rose-600 text-white border-pink-400",
  },
  {
    label: "LinkedIn",
